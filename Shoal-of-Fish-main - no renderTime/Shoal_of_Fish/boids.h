...
#define BOID_LENGTH 0.05f
#define BOID_WIDTH 0.01f
...
struct s_simopts {
	...
	float boidSpeed = 0.005f;
	float visionRadius = 0.1f;
	float visionAngles = 6.0f;
	float cohesionFactor = 0.1f;
	float separationFactor = 0.026f;
	float alignFactor = 0.05f;
};
